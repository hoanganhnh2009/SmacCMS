(function (app) {
    ...
    function ($http, $q, $window, localStorageService, authData) {
        ...
        this.setHeader = function () {
            ...
            if ((authData.authenticationData != undefined) || (authData.authenticationData.accessToken != undefined) ||
                (authData.authenticationData.accessToken != null) || (authData.authenticationData.accessToken != "")) {
