...
using Smac.Common.Exceptions;
using Smac.Model.Models;
using Smac.Service;
using Smac.Web.App_Start;
using Smac.Web.Infrastructure.Core;
using Smac.Web.Infrastructure.Extensions;
using Smac.Web.Models;
    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                IEnumerable<ApplicationUserViewModel> modelVm = Mapper.Map<IEnumerable<Model.Models.ApplicationUser>, IEnumerable<ApplicationUserViewModel>>(model);
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, string id)
        {
            ...
            {
                var applicationUserViewModel = Mapper.Map<Model.Models.ApplicationUser, ApplicationUserViewModel>(user.Result);
