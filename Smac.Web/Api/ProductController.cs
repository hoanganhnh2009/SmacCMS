...
namespace Smac.Web.Api
{
    ...
    public class ProductController : ApiControllerBase
    {
        ...
        [Route("getall")]
        [HttpGet]
        public HttpResponseMessage GetAll(HttpRequestMessage request,string productName, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                int totalRow = 0;
                var model = _productService.GetAll(productName);
        ...
        [HttpDelete]
        [AllowAnonymous]
        public HttpResponseMessage PublishMulti(HttpRequestMessage request, string checkedProducts)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
